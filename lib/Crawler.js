...
module.exports = class Crawler {
    ...
    async getSingleCourse(url) {
        return Promise
            ...
            .then(async ({ course: { data }, parts }) => {
                ...
                //let seriesResponse = await this._request({ url: `${this.url}/watch/${data.slug}` })
                //console.log('seriesResponse', seriesResponse.props);
                //add additional info for courses
                // return seriesResponse.props.parts.data.map(s => {
                return parts.data.map(s => {
                    /* data: {
                         ...
                         description_markdown: '<p>Learn the basics of regular expressions.</p>\n',
                         free: true,
                         ongoing: false,
                         upcoming: false,
                         type: 'course',
                         ...
                         has_new_parts: false,
                         duration: [Object],
                         created_at_human: '6 years ago',
                         created_at: '2015-07-24 07:46:21',
                         subjects: [Array],
                         user: [Object],
                         parts_count: 11,
                         authors: [],
                         url: 'https://nova.codecourse.com/courses/regular-expressions-basics',
                         newsletter: false,
                         replacement: null
                     }
                 },*/
                    /*{
                        ...
                        duration: '01:33',
                        new: false,
                        video: { id: 1958, vimeo_id: '338693646', has_download: true },
                        course_slug: 'regular-expressions-basics'
                    }*/
                    /*{
                        id: 10,
                        title: 'Regular Expressions',
                        ...
                        codes: [],
                        parts_count: null,
                        url: 'https://codecourse.com/courses/regular-expressions-basics',
                        newsletter: false,
                        replacement: null
                    }
                }*/
    ...
    async extractVideos(course) {
        ...
        let downloadLink = `https://codecourse.com/parts/${course.slug}/download`
        // console.log('course.download', course.video.has_download, downloadLink);
        return {
            series,
            url,
            title,
            position,
            downPath,
            ...(course.video.has_download && { downloadLink })
        }
    }
    ...
    async _vimeoRequest(course) {
        ...
        if (course.downloadLink && !some(formats, v => v.width === 1920 )) {
            // console.log('get download link from page', course.downloadLink);
            const { body } = await this._got(course.downloadLink, {
            ...
            // const s = await this._got(course.downloadLink, { method: 'HEAD' })
