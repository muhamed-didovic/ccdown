...
module.exports = class Crawler {
            ...
            .then(async (courses) => {
                ...
                return await Promise
                    .map(courses, async (course) => {
                        ms.update('info', { text: `Course: ${this.url}/courses/${course.slug}` });
                        ...
                        ms.update('info', { text: `${course.slug} has ${seriesResponse.props.parts.data.length} videos` });
    ...
    async extractVideos({ course, ms, index, total }) {
        ...
        // console.log('course.download', course.video.has_download, url);
        return {
            series,
